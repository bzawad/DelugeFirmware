...
DxConvertAll dx_convert_all{l10n::String::STRING_FOR_DX_CONVERT_ALL};

void DxConvertAll::beginSession(MenuItem* navigatedBackwardFrom) {
	soundEditor.shouldGoUpOneLevelOnBegin = true;
	display->setNextTransitionDirection(1);
	dxBrowser.setConvertAllMode(true);
...
MenuItem* DxConvertAll::selectButtonPress() {
